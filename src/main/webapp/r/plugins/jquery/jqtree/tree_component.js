		...
		return {
			...
			off_height : function () {
				if(this.offset === false) {
					...
					var tmp = 0;
					tmp = parseInt( this.container.css("paddingTop",true))||10;   /*$.curCSS(this.container.get(0), "paddingTop", true),10*/
					if(tmp) this.offset.top += tmp;
					tmp = parseInt( this.container.css("borderTopWidth",true))||10;   // $.curCSS(this.container.get(0), "borderTopWidth", true),10);
					if(tmp) this.offset.top += tmp;

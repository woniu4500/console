 ...
 * @version 1.0.0
 */
public interface IMhtRiskDataService {
	 ...
	 */
	ExtData<MhtRiskDataVo> doInsertMhtRiskData(MhtRiskDataVo mhtRiskDataVo,SysUserVo userVo)
			throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	ExtData<MhtRiskDataVo> findMhtRiskData(List<Filter> filters, Page page) throws Exception;
